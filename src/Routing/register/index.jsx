...
class Validation extends React.Component {
  ...
  handleSubmit =  event => {
    ...
    } else if (nohp.value.match(phone)){
            ...
            <Form className="register" onSubmit={this.handleSubmit}>
              <Form.Group className="mb-3">
                ...
                <Row className="input-item">
                  ...
                  <Form.Control type="tel" name='nohp' onChange={e => this.setState ({nohp : e.target.value})}/>
                </Row>
                <Row className="input-item">
                ...
                <Button size="lg" className='btnr' type="submit" value="Submit"> Registrasi </Button>
              </Form.Group>
            </Form>
